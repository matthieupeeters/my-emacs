...
;; From https://github.com/nicferrier/emacs-uuid
...
;; And some code from https://www.ianoxley.com/blog/2015/03/27/inserting-a-guid-in-emacs

(defun uuid-insert()
  (interactive)
  (require 'uuid)
  (insert (downcase (uuid-string))))
